...
import br.gov.serpro.rtc.api.model.xml.nfce.InfNFe;
import br.gov.serpro.rtc.api.model.xml.nfce.InfNFe.Det;
import br.gov.serpro.rtc.api.model.xml.nfce.InfNFe.Det.Imposto;
import br.gov.serpro.rtc.api.model.xml.nfce.InfNFe.Total;
import jakarta.xml.bind.JAXBContext;
import jakarta.xml.bind.JAXBException;
import jakarta.xml.bind.Marshaller;

/**
 * Serviço para serialização de NFCe em XML.
 * 
 * IMPORTANTE: Cria um novo Marshaller para cada operação para garantir thread-safety.
 */
@Service
public class NfceXmlService {

    private final JAXBContext jaxbContext;
    private final ModelMapper mapper;
    
    public NfceXmlService(@Qualifier("jaxbInfNfceContext") JAXBContext jaxbContext) {
        super();
