...
import br.com.augustus.backend.api.model.input.auth.LoginInput;
import br.com.augustus.backend.api.model.input.auth.ReenviarVerificacaoInput;
import br.com.augustus.backend.api.model.input.auth.RefreshInput;
import br.com.augustus.backend.api.model.input.auth.RegistrarUsuarioInput;
import br.com.augustus.backend.api.model.input.auth.VerificarEmailInput;
import br.com.augustus.backend.api.model.output.auth.RegistroOutput;
import br.com.augustus.backend.api.model.output.auth.TokenPairOutput;
import br.com.augustus.backend.api.model.output.auth.UsuarioOutput;
import br.com.augustus.backend.api.openapi.controller.AutenticacaoControllerOpenApi;
import br.com.augustus.backend.domain.service.auth.AutenticacaoService;
