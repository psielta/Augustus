...
class Teste_validacao_2_NcmNaoVinculadaException {
    ...
    @BeforeEach
    void beforeEach(
            final @Value("classpath:entradas/validacoes/Teste_validacao_2_NcmNaoVinculadaException.json") Resource resourceFile)
            throws IOException {
    ...
    void teste_controller_CalcularTributos() throws Exception {
        ...
        mockMvc.perform(post("/calculadora/regime-geral")
                ...
                .andExpect(jsonPath("$.title").value("NCM não vinculada"));
    }
