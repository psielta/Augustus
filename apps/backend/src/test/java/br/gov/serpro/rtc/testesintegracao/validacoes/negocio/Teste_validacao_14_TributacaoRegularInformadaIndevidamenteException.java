...
@Disabled
class Teste_validacao_14_TributacaoRegularInformadaIndevidamenteException {
    ...
    @BeforeEach
    void beforeEach(final @Value("classpath:entradas/validacoes/Teste_validacao_14_TributacaoRegularInformadaIndevidamenteException.json") Resource resourceFile)
            throws Exception {
    ...
    void teste_service_CalcularTributos() {
        assertThatThrownBy(() -> calculadoraService.calcularTributos(operacao))
                .isExactlyInstanceOf(TributacaoRegularInformadaIndevidamenteException.class);
    }
    ...
    void teste_controller_CalcularTributos() throws Exception {
        ...
        mockMvc.perform(post("/calculadora/regime-geral")
                ...
                .andExpect(jsonPath("$.title").value("Grupo de tributação regular informado indevidamente"));
    }
