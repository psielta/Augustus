...
class Teste_validacao_16_ImpostoSeletivoInformadoIndevidamenteException {
    ...
    void teste_service_CalcularTributos() {
        assertThatThrownBy(() -> calculadoraService.calcularTributos(operacao))
                .isExactlyInstanceOf(ImpostoSeletivoInformadoIndevidamenteException.class);
    }
    ...
    void teste_controller_CalcularTributos() throws Exception {
        ...
        mockMvc.perform(post("/calculadora/regime-geral")
                ...
                .andExpect(jsonPath("$.title").value("Dados do Imposto Seletivo informados indevidamente"));
    }
