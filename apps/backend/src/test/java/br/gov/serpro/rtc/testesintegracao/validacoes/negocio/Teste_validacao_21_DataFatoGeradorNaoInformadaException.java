...
class Teste_validacao_21_DataFatoGeradorNaoInformadaException {
    ...
    @BeforeEach
    void beforeEach(
            final @Value("classpath:entradas/validacoes/Teste_validacao_21_DataFatoGeradorNaoInformadaException.json") Resource resourceFile)
            throws Exception {
    ...
    void teste_service_CalcularTributos() {
        assertThatThrownBy(() -> calculadoraService.calcularTributos(operacao))
                .isExactlyInstanceOf(DataFatoGeradorNaoInformadaException.class);
    }
    ...
    void teste_controller_CalcularTributos() throws Exception {
        ...
        mockMvc.perform(post("/calculadora/regime-geral")
                ...
                .andExpect(jsonPath("$.title").value("Data do fato gerador não informada"));
    }
