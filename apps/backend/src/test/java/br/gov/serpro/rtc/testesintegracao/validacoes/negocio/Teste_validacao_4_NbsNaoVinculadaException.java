...
class Teste_validacao_4_NbsNaoVinculadaException {
    ...
    @BeforeEach
    void beforeEach(
            final @Value("classpath:entradas/validacoes/Teste_validacao_4_NbsNaoVinculadaException.json") Resource resourceFile)
            throws IOException {
    ...
    void teste_controller_CalcularTributos() throws Exception {
        ...
        mockMvc.perform(post("/calculadora/regime-geral")
                ...
                .andExpect(jsonPath("$.title").value("NBS não vinculada"));
    }
