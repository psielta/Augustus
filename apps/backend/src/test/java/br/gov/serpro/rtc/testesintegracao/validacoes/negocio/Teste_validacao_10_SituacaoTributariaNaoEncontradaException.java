...
class Teste_validacao_10_SituacaoTributariaNaoEncontradaException {
    ...
    @BeforeEach
    void beforeEach(
            final @Value("classpath:entradas/validacoes/Teste_validacao_10_SituacaoTributariaNaoEncontradaException.json") Resource resourceFile)
            throws Exception {
    ...
    void teste_service_CalcularTributos() {
        assertThatThrownBy(() -> calculadoraService.calcularTributos(operacao))
                .isExactlyInstanceOf(SituacaoTributariaNaoEncontradaException.class);
    }
    ...
    void teste_controller_CalcularTributos() throws Exception {
        ...
        mockMvc.perform(post("/calculadora/regime-geral")
                ...
                .andExpect(jsonPath("$.title").value("Situação tributária não encontrada"));
    }
