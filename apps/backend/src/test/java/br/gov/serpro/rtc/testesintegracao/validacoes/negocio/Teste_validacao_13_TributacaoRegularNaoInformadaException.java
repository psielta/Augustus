...
class Teste_validacao_13_TributacaoRegularNaoInformadaException {
    ...
    @BeforeEach
    void beforeEach(
            final @Value("classpath:entradas/validacoes/Teste_validacao_13_TributacaoRegularNaoInformadaException.json") Resource resourceFile)
            throws Exception {
    ...
    void teste_service_CalcularTributos() {
        assertThatThrownBy(() -> calculadoraService.calcularTributos(operacao))
                .isExactlyInstanceOf(TributacaoRegularNaoInformadaException.class);
    }
    ...
    void teste_controller_CalcularTributos() throws Exception {
        ...
        mockMvc.perform(post("/calculadora/regime-geral")
                ...
                .andExpect(jsonPath("$.title").value("Grupo de tributação regular não informado"));
    }
