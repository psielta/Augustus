...
class Teste_validacao_8_ClassificacaoTributariaNaoVinculadaException {
    ...
    @BeforeEach
    void beforeEach(
            final @Value("classpath:entradas/validacoes/Teste_validacao_8_ClassificacaoTributariaNaoVinculadaException.json") Resource resourceFile)
            throws IOException {
    ...
    void teste_service_CalcularTributos() {
        assertThatThrownBy(() -> calculadoraService.calcularTributos(operacao))
                .isExactlyInstanceOf(ClassificacaoTributariaNaoVinculadaSituacaoTributariaException.class);
    }
    ...
    void teste_controller_CalcularTributos() throws Exception {
        ...
        mockMvc.perform(post("/calculadora/regime-geral")
                ...
                .andExpect(jsonPath("$.title").value("Classificação tributária não vinculada à situação tributária"));
    }
